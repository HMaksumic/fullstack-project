...
const MercedesCarList = () => {
  ...
  useEffect(() => {
    //axios.get('http://127.0.0.1:8080/api/olx_mercedes') //for dev testing
    axios.get('https://backend-server-hcvn.onrender.com/api/olx_mercedes') //above api hosted by third party
      .then(response => {
...
export default MercedesCarList;
